...
public class GameOver extends Scene {
    private final GameTask gameTask1 = new GameTask(this::randBoom, 50, true);
    private final GameTask gameTask2 = new GameTask(this::randBoom, 150, true);
    private final GameTask gameTask3 = new GameTask(this::killSprites, 400, true);
