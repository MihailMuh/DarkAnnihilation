...
public final class UriManager {
    ...
    public static synchronized Uri images(String folder, int name, String type) {
        stringBuilder.setLength(0);
        return Uri.parse(stringBuilder.append(pathImages).append(folder).append(name).append(type).toString());
    }
