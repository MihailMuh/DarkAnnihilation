...
public final class Constants {
    ...
    public static final byte NUMBER_SKULL_EXPLOSION = 13;
    ...
    public static final short FACTORY_HEALTH = 200;
    ...
    public static final byte SATURN_SHOOT_TIME = 127;
    public static final byte SATURN_SHOTGUN_TIME = 100;
    ...
    public static final short NUMBER_THUNDER_SCREEN_IMAGES = 20;
